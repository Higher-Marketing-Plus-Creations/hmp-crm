...
class ClientConversationSettingController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        $data = $request->validate([
            ...
            'industry_niche' => ['nullable', 'string'],
            ...
            'services_not_offered' => ['nullable', 'array'],
            'lead_scoring_rules' => ['nullable', 'array'],
            'appointment_booking_flow' => ['nullable', 'array'],
            'conversation_style_rules' => ['nullable', 'array'],
            'first_message' => ['nullable', 'string'],
            'closing_messages' => ['nullable', 'array'],
            'kb_categories' => ['nullable', 'array'],
            'faq_categories' => ['nullable', 'array'],
            'reasoning_rules' => ['nullable', 'array'],
            'handoff_summary_template' => ['nullable', 'string'],
            'tone_examples' => ['nullable', 'array'],
            'preferred_phrases' => ['nullable', 'array'],
            'forbidden_phrases' => ['nullable', 'array'],
            'conversation_examples' => ['nullable', 'array'],
